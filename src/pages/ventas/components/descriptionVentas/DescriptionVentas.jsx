export default function DescriptionVentas() {
  return (
    <section className='description-ventas'>
      <h2 className='description-ventas__title'>
        ¿Qué se verá dentro del programa El arte de producir?
      </h2>
      <p className='description-ventas__subtitle'>
        Éste es un curso online sobre producción de artes escénicas en el que se
        trabajará para poder materializar proyectos y darles vida a tus ideas y
        sueños.
      </p>
      ...
      <p className='description-ventas__text'>
        Además, las sesiones serán grabadas por lo que podrás tomarlas y
        repetirlas cuando quieras. Sin embargo, te invitamos a que en la medida
        de lo posible, asistas a las sesiones en vivo para que no te pierdas el
        diálogo y las rondas de preguntas/respuestas.
      </p>
      ...
      <div className='description-ventas__element'>
        ...
        <ul className='description-ventas__list'>
          ...
          <li className='description-ventas__list-element'>Financiamientos</li>
          <li className='description-ventas__list-element'>Alianzas</li>
        </ul>
      </div>
      <div className='description-ventas__element'>
      ...
      <div className='description-ventas__element'>
        ...
        <h3 className='description-ventas__element-title'>
          Aterriza tu proyecto (CONSOLIDAR EL PROYECTO)
        </h3>
        <ul className='description-ventas__list'>
          <li className='description-ventas__list-element'>
            Clarifica tus ideas
